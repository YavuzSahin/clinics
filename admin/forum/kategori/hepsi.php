<div class="row">
    <div class="col-lg-12">
        <section class="card">
            ...
            <div class="card-body">
                <a href="forum.php?s=kategori&p=ekle" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Yeni Kategori Ekle</a>
                <div class="adv-table">
                    <table  class="display table table-bordered table-striped" id="dynamic-table">
                        ...
                        <tr>
                            ...
                            <th width="25%" class="hidden-phone">Yazar</th>
                        ...
                        <tr class="gradeX <?php if($kategori->silinme_tarihi!=NULL){?>alert alert-danger<?php } ?>" valign="middle">
                            ...
                            <td class="<?php if($kategori->silinme_tarihi!=NULL){?>alert alert-danger<?php } ?>">
                                    <a href="forum.php?s=kategori&p=duzenle&id=<?=$kategori->id;?>" class="btn btn-success btn-sm"><i class="fa fa-pencil"></i></a>
                                <?php if($kategori->silinme_tarihi!=NULL){?>
                                    <a href="forum.php?s=kategori&p=yayinla&id=<?=$kategori->id;?>" class="btn btn-primary btn-sm"><i class="fa fa-check"></i></a>
                                <?php }else {?>
                                    <a href="forum.php?s=kategori&p=kaldir&id=<?=$kategori->id;?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a>
                                <?php } ?>
                            </td>
                        </tr>
                        <?php } ?>
