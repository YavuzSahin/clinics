    ...
    <div class="col-lg-12">
        <section class="card">
            <header class="card-header">
                <strong><?=$kategori->baslik;?></strong> Forum Kategorisini Yeniden Yayınla
            </header>
            <div class="card-body">
                <?php
                ...
                <form action="?s=kategori&p=yayinla&is=yayinla" method="post" enctype="multipart/form-data">
                    ...
                    <p><strong><?=$kategori->baslik;?></strong> Forum Kategorisini Yeniden Yayınlamak İstediğinizden Emin misiniz?</p>
