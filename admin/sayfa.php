                ...
                if(isset($_GET['s'])) {
                    switch ($_GET['s']) {
                        case'kategori':
                                switch (@$_GET['p']){
                                    default:
                                        include_once 'sayfa/kategori/hepsi.php';
                                        break;
                                    case'ekle':
                                        include_once 'sayfa/kategori/ekle.php';
                                        break;
                                    case'duzenle':
                                        include_once 'sayfa/kategori/duzenle.php';
                                        break;
                                    case'kaldir':
                                        include_once 'sayfa/kategori/kaldir.php';
                                        break;
                                    case'yayinla':
                                        include_once 'sayfa/kategori/yayinla.php';
                                        break;
                                }
                            break;
                        case'etiket':
                            switch (@$_GET['p']){
                                default:
                                    include_once 'sayfa/etiket/hepsi.php';
                                    break;
                                case'ekle':
                                    include_once 'sayfa/etiket/ekle.php';
                                    break;
                                case'duzenle':
                                    include_once 'sayfa/etiket/duzenle.php';
                                    break;
                                case'kaldir':
                                    include_once 'sayfa/etiket/kaldir.php';
                                    break;
                                case'yayinla':
                                    include_once 'sayfa/etiket/yayinla.php';
                                    break;
                            }
                            break;
                        case'icerik';
                            switch (@$_GET['p']){
                                default:
                                    include_once 'sayfa/icerik/hepsi.php';
                                    break;
                                case'ekle':
                                    include_once 'sayfa/icerik/ekle.php';
                                    break;
                                case'duzenle':
                                    include_once 'sayfa/icerik/duzenle.php';
                                    break;
                                case'kaldir':
                                    include_once 'sayfa/icerik/kaldir.php';
                                    break;
                                case'yayinla':
                                    include_once 'sayfa/icerik/yayinla.php';
                                    break;
                            }
                            break;
                            break;
