                ...
                if(isset($_GET['s'])) {
                    switch ($_GET['s']) {
                        case'merkez':
                                switch (@$_GET['p']){
                                    default:
                                        include_once 'sayfa/klinik/hepsi.php';
                                        break;
                                    case'ekle':
                                        include_once 'sayfa/klinik/ekle.php';
                                        break;
                                    case'duzenle':
                                        include_once 'sayfa/klinik/duzenle.php';
                                        break;
                                    case'kaldir':
                                        include_once 'sayfa/klinik/kaldir.php';
                                        break;
                                    case'yayinla':
                                        include_once 'sayfa/klinik/yayinla.php';
                                        break;
                                }
                            break;
                        case'il':
                            switch (@$_GET['p']){
                                default:
                                    include_once 'sayfa/il/hepsi.php';
                                    break;
                                case'ekle':
                                    include_once 'sayfa/il/ekle.php';
                                    break;
                                case'duzenle':
                                    include_once 'sayfa/il/duzenle.php';
                                    break;
                                case'kaldir':
                                    include_once 'sayfa/il/kaldir.php';
                                    break;
                                case'yayinla':
                                    include_once 'sayfa/il/yayinla.php';
                                    break;
                            }
                            break;
                        case'ilce';
                            switch (@$_GET['p']){
                                default:
                                    include_once 'sayfa/ilce/hepsi.php';
                                    break;
                                case'ekle':
                                    include_once 'sayfa/ilce/ekle.php';
                                    break;
                                case'duzenle':
                                    include_once 'sayfa/ilce/duzenle.php';
                                    break;
                                case'kaldir':
                                    include_once 'sayfa/ilce/kaldir.php';
                                    break;
                                case'yayinla':
                                    include_once 'sayfa/ilce/yayinla.php';
                                    break;
                            }
                            break;
                            break;
