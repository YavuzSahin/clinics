                        ...
                        <div class="card-body">
                            ...
                            if(isset($_GET['s'])) {
                                switch ($_GET['s']) {
                                    case'optimize':
                            ?>
                            <button disabled="disabled" class="btn btn-warning btn-sm pull-left"><i class="fa fa-spinner fa-spin "></i> Resimleri Optimize Ediliyor</button>
                            <?php
                            $files = scandir('../upload/resized');
                            foreach ($files as $file){
                                $tiny = new \Tinify\Tinify();
                                $tinyE = new \Tinify\Source();
                                $tiny::setKey('W5JFFkYDng6XfRBzTz4R2h7w9bPbvfmC');
                                $tinyE::fromFile('../upload/resized/'.$file)->toFile('../upload/resized/'.$file);
                                echo '<div class="alert alert-success">'.$file." resmi başarıyla optimize edildi.</div><br>";
                            }
                            break;
                            }
                            }else{
                            ?>
                            <a href="resim.php?s=optimize" class="btn btn-success btn-sm pull-left"><i class="fa fa-cogs"></i> Resimleri Optimize Et!</a>
                            <?php } ?>
                        </div>
                    </section>
