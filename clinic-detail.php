                ...
                <div class="col">
                    <div class="left-content details-page">
                        ...
                        <div class="clinic-detail">
                            <?=$pageInfo->hakkinda;?>
                            <p><strong><?=sehir($pageInfo->city);?></strong> saç ekim merkezleri arasında faaliyet gösteren <strong><?=$siteBaslikic;?></strong>, FUE Saç Ekimi ve DHI Saç Ekimi gibi saç ekimi çözümlerini saç ekimi hastalarına özel alternatif sunarak saç ekimi operasyonlarını gerçekleştirmektedir.<br>
                                Saç ekimi alanında, mükemmel saç ekimi sonucu başarılara imza atan <strong><?=$siteBaslikic;?></strong>, uzman kadrosu ile ihtiyaçları analiz ederek, en hızlı, uygun ve kaliteli hizmet politikası ile saç ekimi hastalarına hizmet vermektedir.<br>
                                ...
                                Yurtiçinden ve yurtdışından geniş bir kitleye hitap eden <strong><?=$siteBaslikic;?></strong> günden güne saç ekimi başarısını arttırmaktadır.<br>
                                ...
                                Saç ekimi yaptıran hastaların memnuniyet oranı bir hayli yüksek olan <strong><?=$siteBaslikic;?></strong> saç ekimi işlemi sonrasında da hastalarına gereken tüm hizmetleri vermektedir.<br>
                                <strong>Saç ekimi <?=sehir($pageInfo->city);?></strong> denince akla ilk gelen merkezlerden biri olan <strong><?=$siteBaslikic;?></strong> saç ekimi konusundaki çalışmalarını özenle devam ettirmektedir.<br>
